...
from .views import signup_api,login_api,users_api,logout_api,assign_role_api,user_role_list,roles_choices,apply_internship,applicants_list,applicant_detail,approve_students,contactus,get_approved_list,assign_tasks,get_assignedtasks,post_comment,view_comment,post_report,get_report
...
urlpatterns = [
    ...
    path('getreports/', get_report, name='getreports'),
